...
void PrintInstructions() {
    ...
    drawString(100, 340, "The rules of the game are defined by the blocks in the level.", 0x00FFFFFF, 4);
    drawString(100, 440, "For example, if you see the blocks 'BABA IS YOU', you control Baba.", 0x00FFFFFF, 4);
    drawString(100, 540, "If the blocks say 'ROCK IS PUSH', you can push rocks.", 0x00FFFFFF, 4);
    drawString(100, 640, "When you touch a flag that is marked 'FLAG IS WIN', you win the level!", 0x00FFFFFF, 4);
    drawString(100, 740, "You can change the rules by moving the blocks around.", 0x00FFFFFF, 4);
